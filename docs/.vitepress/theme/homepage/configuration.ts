...
export const SummaryContent : string[] = [
    ...
    "Compose document content with dozens of powerful and predictable structural building blocks, e.g. text, image, border, background, table, etc.",
    ...
    "Don't be limited to any proprietary scripting language or format. Follow your experience and use all C# features to your advantage.",
...
export const UserGroupsContent : HomePageUserGroup[] = [
    ...
    },
    {
        ...
        description: "The QuestPDF library provides a stable foundation for the PDF generation functionality, regardless of the application type. Constantly improving quality, high stability and developer-friendly architecture - this is a key for every successful project. The open-source nature makes it a safe and reliable choice."
    }
];
